...
public class Cappuccino extends Coffee {
    ...
    private static final float COFFEE_AMOUNT = 10.0f;
    private static final float WATER_AMOUNT = 45.0f;
    ...
    public Cappuccino(String sugarAmountCode){
    ...
    public int productType(){ return 11;}
}
